...
class LocalSearch2:
    ...
    def __init__(self, useMove, useSwap, useMerge, w1, e1, w2, e2, w3, e3):
            ...
            for i in itemOrder:
                for j in binOrder:
                    ...
                    if binPackingInstance.evaluate(new_solution, self.w1, self.e1, self.w2, self.e2, self.w3, self.e3)[0] > self.curr_solutionValue: # > because maximizatione
                        [self.curr_solutionValue, self.maximumViolationsOverViolationTypes] = binPackingInstance.evaluate(new_solution, self.w1, self.e1, self.w2, self.e2, self.w3, self.e3)
                        self.curr_solution = new_solution
                        return True
        else:
            if binPackingInstance.evaluate(input_solution, self.w1, self.e1, self.w2, self.e2, self.w3, self.e3)[0]\
                > self.curr_solutionValue:  # > because maximization
                [self.curr_solutionValue, self.maximumViolationsOverViolationTypes] = binPackingInstance.evaluate(input_solution, self.w1, self.e1, self.w2, self.e2, self.w3, self.e3)
